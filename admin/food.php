...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	{
		$stmt = $conn->prepare("INSERT INTO `pizza`(`id`, `product_name`, `product_image`, `product_price`, `product_code`, `restId`) VALUES ('','".$restName."','".$image."','".$restId."','".$price."','".$rest."')");
		$stmt->execute();
		$conn->close();
...
<body>
	...
	<p style="font-size:250%" align="center" > <font color="#CB0648" ;face="Courier New";><b>Add Food</b></font> </p>
	...
	<table align="center" bgcolor="" width="60%" height="300" border="0">
		<tr>
			<td align="right" width="25%">Product ID:</td>
		...
		<tr>
			...
			<td align="center"><input id="rcorners" style="height:40px;font-size:14pt;" type="number" name="price" size="35" placeholder="" value=""></td>
		</tr>
